    ...
    return (
        <Fragment>
            ...
            <div class="col-12 col-lg-8 mt-5 order-confirm">
                ...
                <p class="mb-4"><b>Address:</b> {`${shippingInfo.address}, ${shippingInfo.city},
			...
			<div class="col-12 col-lg-3 my-4">
                    <div id="order_summary">
                        ...
                        <hr />
                        <button id="checkout_btn" class="btn btn-primary btn-block" onClick={processToPayment}>Proceed to Payment</button>
                    </div>
                </div>
            </div>
